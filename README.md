...
[![Stars](https://img.shields.io/github/stars/Solara-Execute-Update-v3.5?style=flat-square)](https://github.com)
...
git clone https://github.com/Solara-Execute-Update-v3.5.git
cd Solara-Execute-Update-v3.5
